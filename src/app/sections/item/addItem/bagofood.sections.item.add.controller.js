(function () {
  ...
  angular.module('bagofood.sections.item.add.controller', ['bagofood.sections.item.product.detail.controller'])
    .controller('AddItemController', ['$stateParams', '$modal', '$log', '$previousState', 'ngTableParams', 'ProductService', 'CONST', 'FoodListService', 'ProductModalDetailsService', '$scope',
      function ($stateParams, $modal, $log, $previousState, ngTableParams, ProductService, CONST, FoodListService, ProductModalDetailsService, $scope) {
